...
public class RedisBackedTokenBucket {
    ...
    private static final RedisScript<Long> RESERVE_SCRIPT = new DefaultRedisScript<>(
            "local bucketKey = KEYS[1]\n" +
                    ...
                    "        redis.call('EXPIRE', bucketKey, windowSeconds * 10)\n" +
                    "    end\n" +
                    "    \n" +
    ...
    public RedisBackedTokenBucket(String key, long capacity, long refillTokens, long windowSeconds,
    ...
    public boolean tryConsume(int tokensToConsume) {
        throw new UnsupportedOperationException(
                "Phase 1 tryConsume is deprecated. Use tryReserve, commit, and rollback.");
    }
