 ...
 * A user can be assigned a tier (FREE, PRO, ENTERPRISE, UNLIMITED) which
 * dictates their specific rate limits. If tierExpiresAt is set and has passed,
 * the system automatically downgrades the user to FREE.
 */
@Getter
@Setter
@AllArgsConstructor
...
public class User {
    ...
    /**
     * The tier assigned to this user (e.g., "FREE", "PRO", "ENTERPRISE", "UNLIMITED").
